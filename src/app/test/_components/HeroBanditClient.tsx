...
export default function HeroBanditClient({
  ...
  React.useEffect(() => {
    ...
    const start = () => {
      if (hbTimer === null) hbTimer = window.setInterval(() => {
          ...
          <div className="space-y-4">
              ...
              >
                {variant === "A" && (
                  <>
                    ...
                    <p className="text-gray-600">
                      Screening inicial en 4–6 minutos. Obtén una indicación clara para decidir si vale la pena una
                      evaluación completa.
                    </p>
                  </>
                )}
                {variant === "B" && (
                  <>
                    ...
                    <p className="text-gray-600">
                      Responde un cuestionario breve y recibe una orientación práctica para tu siguiente paso terapéutico.
                    </p>
                  </>
                )}
              </motion.div>
            ...
            >
              <li className="flex items-center gap-2">
                ...
                Orientación clara al final del test
              </li>
              <li className="flex items-center gap-2">
